...
function Home() {
    ...
    return (_jsxs("main", { className: 'generic-container-1 p1 m1', children: [user && _jsx("div", { className: 'generic-container-3 font-5', children: _jsxs("div", { className: 'generic-container-3 card-sub-main quad-box-shadow-2', children: ["   ", _jsx("h1", { className: 'font-1 white s5', children: "Welcome" }), _jsxs("div", { className: 'generic-container-3 font-5', children: [_jsxs("p", { children: [_jsx("strong", { className: 'font-6', children: "Name : " }), " ", user.name] }), _jsxs("p", { children: [_jsx("strong", { className: 'font-6', children: "Email : " }), " ", user.email] }), _jsx("p", { children: _jsx(Button_S2, { onClick: onLogoutClicked, children: " Logout " }) })] })] }) }), _jsxs("section", { children: ["  ", _jsxs("article", { className: 'card-sub-main p4 m5 quad-box-shadow-2', children: [_jsxs("div", { className: 'centered', children: [_jsx("h2", { className: 'font-3', children: "Create New Project" }), _jsxs("form", { className: 'form-generic', onSubmit: (e) => onFormSubmitted(e), children: [_jsx("input", { className: "form-generic-input font-2", type: "text", placeholder: "Project Name", id: "projectName", name: "projectName", value: projectName, onChange: (e) => { onFormUpdated(e); } }), _jsx(Button_S2, { type: 'submit', children: "Create" })] })] }), _jsx("div", { className: 'p3 m3', children: data && user &&
                                    _jsxs("div", { className: 'card-sub p3 m3 quad-box-shadow-1', children: [_jsx("h4", { className: 's3 p2 m2 font-3 centered', children: "Existing Projects" }), data.map((project) => (_jsxs("div", { className: 'card-sub-child p3 m3', children: [_jsxs("div", { className: 'flex', children: [_jsx("h2", { className: 'font-1 s1 p1 m1 orange ', children: "Project Name :" }), " ", _jsx("h3", { className: 'font-2 s4 p3 m3 white', children: project.projectName }), _jsx("div", { className: 'flex parent flex-flow-left', children: _jsx(Button_S2, { className: 'p3 m3', onClick: (e) => { manageSelectedStation(e, project._id); }, children: " Manage " }) })] }), _jsxs("div", { children: [_jsx("h2", { className: 'font-1 s1 p1 m1 orange', children: "Owner :" }), " ", _jsx("h3", { className: 'font-2 s2 p1 m1 white', children: user.name })] })] }, project._id)))] }) })] })] })] }));
}
export default Home;
