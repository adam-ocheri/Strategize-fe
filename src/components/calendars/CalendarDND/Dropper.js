...
export default function Dropper({ items, droppableId, type, children, getAllSubstations, updateTime, manage, isDragging, isDropDisabled = false }) {
    return (_jsx(Droppable, { droppableId: droppableId, type: type, isDropDisabled: isDropDisabled, children: (provided, snapshot) => (_jsxs("div", { ...provided.droppableProps, ref: provided.innerRef, ...provided.innerRef, className: 'normalize-content', children: [items.map((item, index) => (_jsx(Dragger, { item: item, index: index, getAllSubstations: getAllSubstations, updateTimeForDate: updateTime, manage: manage, droppableProvided: provided, isDragging: isDragging }, item._id))), provided.placeholder] })) }));
}
