...
import { Box, Card, CardBody, CardHeader, Flex, Switch } from '@chakra-ui/react';
...
function Task({}) {
    ...
    return (_jsxs("div", { className: 'pt3 mt3 m3 b-color-dark-2 white border-left-w1 border-left-white border-left-solid border-right-w1 border-right-white border-right-solid border-bottom-w1 border-bottom-white border-bottom-solid', children: [activeLTG && activeObjective &&
                _jsx("h3", { className: 'font-1 white station-nav-link-container b-color-dark-1', children: _jsxs("div", { className: 'p4 m4', children: [_jsx(Link, { to: '/project', className: 'station-nav-link', children: activeProject.projectName }), " ", _jsx(ArrowRightIcon, {}), _jsx(Link, { to: '/project/ltg', className: 'station-nav-link', children: activeLTG.LTGName }), " ", _jsx(ArrowRightIcon, {}), _jsx(Link, { to: '/project/ltg/objective', className: 'station-nav-link', children: activeObjective.objectiveName }), " ", _jsx(ArrowRightIcon, {}), _jsx(Link, { to: '/project/ltg/objective/task', className: 'station-nav-link-active', children: activeTask.taskName })] }) }), _jsx("div", { className: 'pb1 mb5 border-top-w1 border-top-white border-top-solid' }), _jsx("div", { className: ' p3 m3', children: _jsxs("section", { className: 'font-3', children: [originTask?.HISTORY_TaskIterations?.length > 0 && _jsxs("div", { className: 'centered flex f-dir-col', children: [_jsxs("div", { children: [_jsx(Button_S2, { onClick: () => onSubtaskIterationChange(-1), children: '<' }), _jsx("span", { children: "Task Iteration" }), _jsx(Button_S2, { onClick: () => onSubtaskIterationChange(1), children: '>' })] }), originTask && _jsxs("div", { children: [_jsx("button", { className: `red task-iterations ${activeTask.iteration === 0 ? 'task-iteration-active' : ''}`, onClick: () => setCurrentTaskIteration(0), children: 'O' }), originTask && originTask.HISTORY_TaskIterations.map((item) => (_jsx("button", { className: `white task-iterations ${item.iteration === currentTaskIteration ? 'task-iteration-active' : ''}`, onClick: () => setCurrentTaskIteration(item.iteration), children: item.iteration }, item._id)))] })] }), _jsx("div", { style: { borderRadius: '10px', marginBottom: '3%' }, children: _jsxs(Card, { background: 'transparent', padding: '1%', border: '2px dashed white', borderRadius: '10px', children: [_jsx(Flex, { direction: 'row', padding: '1vw', justifyContent: 'space-between', alignSelf: '', children: _jsxs(CardBody, { border: '1px solid white', borderRadius: '10px', alignSelf: 'center', minW: '55vw', background: '#5f22ed', children: [_jsxs("h2", { className: 'font-1 s4 white', children: [activeTask.taskName, " :", _jsx("span", { className: 'font-5 s2 m3 orange', children: `${activeTask.stationTypeName ? activeTask.stationTypeName : activeTask.stationType ? activeTask.stationType : 'Task'}` })] }), activeTask.description &&
                                                    _jsxs("div", { className: 'font-5 s2 p3 m3', children: [_jsx("span", { className: 's1 orange', children: " Description: " }), " ", _jsx("span", { className: `s2 ml4`, children: activeTask.description })] }), _jsxs(Flex, { direction: 'row', justifyContent: 'space-between', padding: '1vw', margin: '1%', children: [_jsxs(Box, { as: 'article', margin: '5px', children: [_jsxs(Box, { as: 'span', margin: '5px', className: 'orange font-5', children: [`${activeTask.stationTypeName ? activeTask.stationTypeName : activeTask.stationType ? activeTask.stationType : 'Task'}`, " completed"] }), _jsx(Switch, { defaultChecked: taskCompleted, onChange: updateTaskCompletionStatus, margin: '5px', colorScheme: 'green' })] }), _jsxs(Flex, { direction: 'column', alignItems: 'center', children: [_jsx(CardHeader, { className: 'font-1 s2 white', children: "Status" }), _jsx(TaskStatus, { item: activeTask })] })] })] }) }), _jsxs("div", { className: 'p2 m2', children: [_jsx("span", { className: 's1 orange', children: " Date:" }), "  ", _jsx("span", { className: 's2 ml4 white', children: `${activeTask.date !== '' ? activeTask.date.slice(0, 15) : 'No date is set yet'}` }), _jsx("br", {}), _jsx("br", {}), _jsx("br", {}), _jsx("span", { className: 's1 orange', children: "Start Time:" }), " ", _jsxs("span", { className: 's2 ml4 white', children: [`${activeTask.date !== '' ? activeTask.date.slice(15, 21) : 'No Time is set yet'}`, _jsx(TaskTimeManagement, { user: user, item: activeTask, type: 'start' })] }), _jsx("br", {}), _jsx("span", { className: 's1 orange', children: "End Time:" }), " ", _jsxs("span", { className: 's2 ml4 white', children: [`${activeTask.endTime !== '' ? activeTask.endTime.slice(15, 21) : 'No Time is set yet'}`, _jsx(TaskTimeManagement, { user: user, item: activeTask, type: 'end' })] })] })] }) }), _jsx("div", { className: 'p2 m2 border-top-w0 border-top-white border-top-solid' }), _jsx("article", { className: 'p2 m2', children: _jsx("div", { className: 'pb3 mb3 border-top-w0 border-top-white border-top-dashed', children: _jsx(Settings_Task, { originTask: originTask, currentTaskIteration: currentTaskIteration }) }) })] }) })] }));
}
;
export default Task;
